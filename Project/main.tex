...
\node[left] at (-0.2,6) {Attacker};
\node[left] at (-0.2,5) {Client};
\node[left] at (-0.2,4) {Resolver};
\node[left] at (-0.2,3) {Nameserver};
\node[left] at (-0.2,2) {Phishing Site};

% Attack flow with clear labels
\draw[->,thick] (1,5) -- (1.5,4);
\node[right] at (1.6,4.5) {1. Query};

\draw[->,thick] (2,4) -- (2.5,3);
\node[right] at (2.6,3.5) {2. Query};

% Parallel attack responses
\draw[->,red,thick] (1.2,6) -- (1.7,4);
\node[red,right] at (1.8,5) {3a. Spoofed Response 1};

\draw[->,red,thick] (1.8,6) -- (2.3,4);
\node[red,right] at (2.4,5.5) {3b. Spoofed Response 2};

\draw[->,red,thick] (2.4,6) -- (2.9,4);
\node[red,right] at (3.0,5.2) {3c. Spoofed Response N};

% Race condition
\draw[->,blue,thick] (3,3) -- (3.5,4);
\node[blue,right] at (3.6,3.5) {4. Legitimate Response};

% Poisoned response
\draw[->,thick] (4,4) -- (4.5,5);
\node[right] at (4.6,4.5) {5. Poisoned Response};

% Phishing
\draw[->,orange,thick] (5,5) -- (5.5,2);
\node[orange,right] at (5.6,3.5) {6. HTTP Request};

\draw[->,orange,thick] (6,2) -- (6.5,5);
\node[orange,right] at (6.6,3.5) {7. Phishing Page};
